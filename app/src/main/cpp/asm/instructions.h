...
static inline void cqo_instruction(program_t* __this) {
	__this->main_thread.registers[REGISTER_FAMILY_d] = msb(__this->main_thread.registers[REGISTER_FAMILY_a]) ? 0 : 0b1111111111111111111111111111111111111111111111111111111111111111; // sign extend into the rdx register
